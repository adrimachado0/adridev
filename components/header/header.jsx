...
const Header = () => {
  return (
    <div className='h-16 w-full left-1/2 -translate-x-1/2 fixed top-0 bg-white border border-white bg-opacity-[0.47] flex flex-col items-center justify-center gap-1 sm:mt-5 px-20 sm:rounded-full sm:w-[470px] sm:flex-row sm:h-12 shadow-md'>
