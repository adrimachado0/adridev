...
const Profile = () => {
  return (
    <div className="flex flex-col items-center mt-3 gap-3 sm:flex-row">
        <button className="font-medium px-5 h-11 rounded-full shadow-md bg-[#101827] text-white flex items-center gap-3">Contact me here <Image alt="ArrowRight" src={ArrowRight} /></button>
        <button className="font-medium px-5 h-11 rounded-full shadow-md bg-[#FCFCFC] flex items-center gap-2">Download CV <Image alt="ArrowDownload" src={ArrowDownload} /></button>
